    ...
    <div class="row">
      <div class="col-lg-6 mb-6">
        <div class="card h-100">
          ...
          <div class="card-body">
            <p class="card-text">Who will select the candidate according to his requirement</p>
          </div>
          <div class="card-footer">
            <a href="emptestpage.jsp" class="btn btn-primary">I am Employer</a>
          </div>
        </div>
      </div>
      <div class="col-lg-6 mb-6">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="jobseekertestpage.jsp" class="btn btn-primary">I am Jobseeker</a>
          </div>
        </div>
      </div>
