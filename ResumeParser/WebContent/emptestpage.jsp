      ...
      <div class="col-lg-6 mb-6">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="emplogin.jsp" class="btn btn-primary">login</a>
          </div>
        </div>
      </div>
      <div class="col-lg-6 mb-6">
        <div class="card h-100">
          ...
          <div class="card-body">
            <p class="card-text">New employer have to register first</p>
          </div>
          <div class="card-footer">
            <a href="Empregistration.jsp" class="btn btn-primary">New Register</a>
          </div>
        </div>
      </div>
